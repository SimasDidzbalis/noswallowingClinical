...
def S(n, cls, inner, eb="", bleed=None, veil=None, pg=True, bg=None, extra="", lift=False):
...
D.append(S(6, "lt", '<div class="mid c">' + plist(P, {"A", "B"}) + '</div>', eb="Problemos 01–15"))
D.append(S(7, "lt", '<div class="mid c">' + plist(P, {"C", "D"}) + '</div>', eb="Problemos 16–26"))
D.append(S(8, "lt", '<div class="mid c">' + plist(P, {"E"})
...
open("nutrioz-katalogas-v4.html", "w", encoding="utf-8").write(html)
print("built %.2f MB, slides=%d, photos=%d" % (
    os.path.getsize("nutrioz-katalogas-v4.html") / 1024 / 1024, html.count('class="s '), len(R)))
