...
HTML=open("nutrioz-katalogas-v4.html",encoding="utf-8").read()
PRINT="""<style>
...
async def main():
    async with async_playwright() as pw:
        ...
        await pg.pdf(path="Nutrioz-katalogas-2026.pdf", width="1600px", height="900px",
                     print_background=True, prefer_css_page_size=True, margin={"top":"0","bottom":"0","left":"0","right":"0"})
        await b.close()
asyncio.run(main())
print("%.2f MB"%(os.path.getsize("Nutrioz-katalogas-2026.pdf")/1024/1024))
